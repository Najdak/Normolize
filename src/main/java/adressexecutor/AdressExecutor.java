...
public class AdressExecutor {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Pattern adressREGEX = Pattern.compile("\\d{2,4}$");
        Pattern filterREGEX = Pattern.compile("[^\\w\\s\\d]");
        // Load the model file downloaded from OpenNLP
        // http://opennlp.sourceforge.net/models-1.5/
        TokenNameFinderModel loc = new TokenNameFinderModel(new File("/home/vladimir/Projects/izsearch/src/main/resources/data/en-ner-location.bin"));
